...
public class PrediosSwingView extends JPanel implements PrediosView {
    ...
    @Override
    public void addAdicionarPredioListener(final ActionListener listener) {
        btnAdicionar.addActionListener(listener);

    }

    @Override
    public void addDeletarPrediosListener(final ActionListener listener) {
        btnDeletar.addActionListener(listener);

    }

    @Override
    public void addAlterarPredioListener(final ActionListener listener) {
