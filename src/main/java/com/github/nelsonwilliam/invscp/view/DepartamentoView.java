...
public interface DepartamentoView extends View {
	...
	/**
	 * Exibe uma mensagem de erro com a mensagem especificada. Por exemplo, pode ser
	 * chamado para avisar que algum campo obrigatório foi deixado vazio.
	 */
	...
	/**
	 * Obtém o departamento com os valores atualmente exibidos no formulário que o
