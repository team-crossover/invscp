...
public class FuncionariosSwingView extends JPanel implements FuncionariosView {
    ...
    @Override
    public void addAdicionarFuncionarioListener(final ActionListener listener) {
        btnAdicionar.addActionListener(listener);

    }

    @Override
    public void addDeletarFuncionariosListener(final ActionListener listener) {
        btnDeletar.addActionListener(listener);
    }

    @Override
    public void addAlterarFuncionarioListener(final ActionListener listener) {
    ...
    @Override
    public List<Integer> getSelectedFuncionariosIds() {
